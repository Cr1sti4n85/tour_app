...
hamburger.addEventListener("click", ()=>{
    ...
    if (mobileNav.style.zIndex == 1) mobileNav.style.zIndex = -1;
    else setTimeout(()=>{
...
},{"./mapbox":"3zDlz","./login":"7yHem","./updateSettings":"l3cGY","./stripe":"10tSC","./alerts":"6Mcnf"}],"3zDlz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayMap", ()=>displayMap);
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiY3BlcmV6bGVjYXJvcyIsImEiOiJjbG42Y2JqYnowZHk5MmlxejFpbHFxaHVzIn0.bPLGX8Alcs_V6sUE7oOHMw";
...
const login = async (email, password)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alertsJs.showAlert)("success", "You have been succesfully logged in");
            window.setTimeout(()=>{
                location.assign("/");
            }, 1500);
        }
...
},{"axios":"jo6P5","./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"10tSC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alertsJs = require("./alerts.js");
const stripe = Stripe("pk_test_51O3TxHIkjI9eOA45hfqQxUuULNbJBHWvaNULoIwe7ua0aqPnJo7sLDrFn1MZbeBuLpHG0OTl4LrlHMNJhmp2P26a00jb2RcQIk");
const bookTour = async (tourId)=>{
    try {
        const response = await (0, _axiosDefault.default).post(`/api/v1/bookings/checkout-session/${tourId}`);
...
},{"axios":"jo6P5","./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["83koz","f2QDv"], "f2QDv", "parcelRequire11c7")
